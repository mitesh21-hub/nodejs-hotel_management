...
(exports.successResponseData = function (
  res,
  data,
  code = 1,
  message = "Success"
  ...
  (exports.deleteSuccessResponseData = function (
    res,
    code = 1,
  ...
  (exports.errorResponseData = function (
    res,
  ...
  (exports.errorResponseWithoutData = function (
    res,
