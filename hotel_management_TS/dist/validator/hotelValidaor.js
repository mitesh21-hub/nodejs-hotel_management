...
var hotelValidation = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var hotelSchema, options, _a, error, value, validationMessageKey;
    return __generator(this, function (_b) {
        hotelSchema = Joi.object({
        ...
        _a = hotelSchema.validate(req.body, options), error = _a.error, value = _a.value;
        if (error) {
...
//# sourceMappingURL=hotelValidaor.js.map