...
var contactValidation = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var contactSchema, options, _a, error, value, validationMessageKey;
    return __generator(this, function (_b) {
        ...
        _a = contactSchema.validate(req.body, options), error = _a.error, value = _a.value;
        if (error) {
